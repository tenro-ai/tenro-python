...
"""LangGraph-based agents using Google Gemini.

These agents demonstrate LangGraph patterns with Google's Gemini models.
"""
...
class CustomerSupportAgentGemini:
    """Answer customer questions using LangGraph with Gemini."""
...
class RAGPipelineGemini:
    """Answer questions using LangGraph RAG workflow with Gemini."""
...
class ConversationAgentGemini:
    """Handle multi-turn conversations with LangGraph using Gemini."""
