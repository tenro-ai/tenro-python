...
"""Pydantic AI-based agents using Google Gemini.

These agents demonstrate Pydantic AI patterns with Google's Gemini models.
"""
...
class CustomerSupportAgentGemini:
    """Answer customer questions using Pydantic AI with Gemini."""
...
class RAGPipelineGemini:
    """Answer questions using Pydantic AI RAG with Gemini."""
...
class ConversationAgentGemini:
    """Handle multi-turn conversations with Pydantic AI using Gemini."""
