...
"""LangChain-based agents using Gemini."""
...
class CustomerSupportAgentGemini:
    """Answer customer questions using knowledge base and LangChain with Gemini."""
...
class RAGPipelineGemini:
    """Answer questions using document retrieval and LangChain with Gemini."""
...
class ConversationAgentGemini:
    """Handle multi-turn conversations with LangChain and Gemini."""
